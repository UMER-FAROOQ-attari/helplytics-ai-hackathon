...
const RequestDetails = () => {
  ...
  const handleHelpClick = async () => {
    try {
      ...
      setRequest(res.data); // ڈیٹا اپڈیٹ کر دو تاکہ سکرین پر نیا نمبر نظر آئے
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white p-8 md:p-14 rounded-[50px] shadow-2xl border border-white/50 relative overflow-hidden">
          ...
          <div className="flex flex-wrap gap-3 mb-8">
            ...
            <span className={`px-5 py-2 rounded-2xl text-xs font-black uppercase tracking-widest ${request.urgency === 'High' ? 'bg-red-100 text-red-600 shadow-[0_0_15px_rgba(220,38,38,0.2)]' : 'bg-orange-100 text-orange-600'}`}>
          ...
          <div className="bg-gray-50 p-8 rounded-[40px] mb-10 border-2 border-dashed border-gray-200">
